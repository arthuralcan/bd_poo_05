...
public class InserirDados extends JFrame {
	...
	public InserirDados() throws SQLException{
		...
		try{
			...
			st.executeUpdate ("INSERT INTO produtos values(1, 'Arroz');");
			st.executeUpdate ("INSERT INTO produtos values(2, 'Feijão');");
			st.executeUpdate ("INSERT INTO produtos values(3, 'Macarrão');");
		}catch(SQLException eSQL){
